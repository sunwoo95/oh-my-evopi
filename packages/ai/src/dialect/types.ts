import type { Dialect as CatalogDialect } from "./compat/identity.js";
import type { Context, Message, ToolCall } from "./compat/types.js";

export type { Dialect } from "./compat/identity.js";
