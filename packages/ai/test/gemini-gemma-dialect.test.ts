...
import type { ToolCall } from "../src/dialect/compat/types.js";
import { createInbandScanner, type Dialect, getDialectDefinition, type InbandScanEvent } from "../src/dialect/index.js";
