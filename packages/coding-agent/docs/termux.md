...
evopi runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
# Clone and install evopi from source
...
Create `~/.evopi/agent/AGENTS.md` to help the agent understand the Termux environment:
