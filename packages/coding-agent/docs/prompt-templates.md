> evopi can create prompt templates. Ask it to build one for your workflow.
...
evopi loads prompt templates from:

- Global: `~/.evopi/agent/prompts/*.md`
- Project: `.evopi/agent/prompts/*.md`
