...
export default defineConfig({
	...
	resolve: {
		alias: [
			{ find: /^@evopi\/pi-ai$/, replacement: aiSrcIndex },
			{ find: /^@evopi\/pi-ai\/oauth$/, replacement: aiSrcOAuth },
			{ find: /^@evopi\/pi-ai\/mcp$/, replacement: aiSrcMcp },
			{ find: /^@evopi\/pi-agent-core$/, replacement: agentSrcIndex },
			{ find: /^@evopi\/pi-tui$/, replacement: tuiSrcIndex },
