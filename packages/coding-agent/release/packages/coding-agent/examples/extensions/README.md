...
cp permission-gate.ts ~/.evopi/agent/extensions/
```
...
| `custom-provider-gitlab-duo/` | GitLab Duo provider using the inherited `@evopi/pi-ai` streaming API through a proxy |
