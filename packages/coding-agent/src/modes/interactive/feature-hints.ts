...
export const FEATURE_HINTS: readonly FeatureHintDefinition[] = [
	...
	{
		id: "subagents",
		getText: () => "evopi can delegate tasks to subagents and run them in parallel.",
	},
	{
		id: "agents-view",
	...
	{
		id: "auto-compaction",
		getText: () => "evopi automatically compacts long sessions before context fills up.",
	},
	{
		id: "auto-refine",
		getText: () => "evopi self-improves by refining skills, memories, prompts, and subagents.",
	},
	{
