...
// a diagnostics tail. The protocol is documented in evopi-runtime/src/rlm/repl.md.
			...
			if (protocol !== REPL_PROTOCOL_VERSION) {
				throw new Error(
					`Kernel runtime speaks protocol ${protocol}, expected ${REPL_PROTOCOL_VERSION}. ` +
						"Update evopi-runtime in the kernel Python (EVOPI_KERNEL_PYTHON) to match this evopi.",
				);
			}
		} catch (e) {
