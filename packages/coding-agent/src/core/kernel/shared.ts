import { registerSessionResourceCleanup } from "@evopi/pi-ai";
...
export const DIFF_DISPLAY_MIME = "application/vnd.evopi.diff+json";

/** MIME tag the `attach-image` skill emits media payloads under. */
export const ATTACHMENT_DISPLAY_MIME = "application/vnd.evopi.attachment+json";

/** MIME tag the `agent-message` skill emits after sending a message. */
export const AGENT_MESSAGE_DISPLAY_MIME = "application/vnd.evopi.agent-message+json";
