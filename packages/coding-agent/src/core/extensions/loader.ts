...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@evopi/pi-agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@evopi/pi-tui");
	const piAiEntry = resolveWorkspaceOrImport("ai/dist/index.js", "@evopi/pi-ai");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@evopi/pi-ai/oauth");

	_aliases = {
		"@evopi/pi-coding-agent": piCodingAgentEntry,
		"@evopi/pi-agent-core": piAgentCoreEntry,
		"@evopi/pi-tui": piTuiEntry,
		"@evopi/pi-ai": piAiEntry,
		"@evopi/pi-ai/oauth": piAiOauthEntry,
