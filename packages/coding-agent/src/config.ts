...
export const SELF_UPDATE_INTERACTIVE_CHILD_ENV = "EVOPI_INTERACTIVE_SELF_UPDATE";
...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Reinstall by re-running the evopi install script (self-update of prebuilt binaries is not published for this build).`;
	}
	if (method === "homebrew") {
...
const envPrefix =
	(piConfigName || "pi")
		...
		.replace(/[^A-Z0-9]+/g, "_")
		.replace(/^_+|_+$/g, "") || "PI";
export const PACKAGE_NAME: string = pkg.name || "@evopi/pi-coding-agent";
export const APP_NAME: string = piConfigName || "pi";
export const APP_TITLE: string = piConfigName ? APP_NAME : "π";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".evopi/agent";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., PI_CODING_AGENT_DIR or EVOPI_CODING_AGENT_DIR
...
// =============================================================================
// User Config Paths (~/.evopi/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.evopi/agent/) */
...
/** Directory where daemon and client diagnostic logs are written (e.g. ~/.evopi/agent/logs/). */
