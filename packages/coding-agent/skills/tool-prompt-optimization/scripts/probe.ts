 ...
 *
 * Routes through @evopi/pi-ai (`completeSimple`) rather than raw HTTP so model
...
import type { Api, AssistantMessage, Model } from "@evopi/pi-ai";
import type { GeneratedProvider } from "@evopi/pi-catalog/models";
import { getBundledModel } from "@evopi/pi-catalog/models";
