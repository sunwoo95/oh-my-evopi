...
import type { AnthropicMessagesCompat, Api, Context, Model, OpenAICompletionsCompat } from "@evopi/pi-ai";
import { getApiProvider } from "@evopi/pi-ai";
import { getOAuthProvider, registerOAuthProvider } from "@evopi/pi-ai/oauth";
...
describe("ModelRegistry", () => {
	...
	describe("baseUrl override (no custom models)", () => {
		...
		test("prime inference requests include selected evopi team header", async () => {
