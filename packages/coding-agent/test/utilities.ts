...
import { getModel, type OAuthCredentials, type OAuthProvider } from "@evopi/pi-ai";
import { getOAuthApiKey } from "@evopi/pi-ai/oauth";
...
// ============================================================================
// OAuth API key resolution from ~/.evopi/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".evopi", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.evopi/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.evopi/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".evopi", "agent");

/**
 * Get an AuthStorage instance backed by ~/.evopi/agent/auth.json
