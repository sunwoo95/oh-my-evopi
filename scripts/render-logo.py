#!/usr/bin/env python3
"""Render an SVG brand mark to ASCII via half-block encoding (dev tool; the shipped mark lives in src/themes/evopi-logo.ts).
...
def main() -> int:
    ...
    default_svg = repo_root / "assets" / "brand" / "evopi-mark.svg"
